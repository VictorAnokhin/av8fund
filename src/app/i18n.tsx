...
const translations: Record<Language, Translation> = {
  en: {
    ...
    hero: {
      ...
      sendSignButton: 'Send',
      sendSignHintExtension: 'Choose a coin, enter recipient and amount, then approve the transfer in your Sui wallet.',
      sendSignHintZkLogin: 'Choose a coin, enter recipient and amount, then send with your Google zkLogin session. If signing fails, sign in with Google again.',
    ...
    mint: {
      ...
      adminCapMissing: 'Set VITE_SUI_RWA_ADMIN_CAP_ID to the RWA AdminCap object your wallet owns, and VITE_SUI_RWA_PACKAGE_ID to the deployed rwa_core package.',
  ...
  ua: {
    ...
    hero: {
      ...
      sendSignButton: 'Відправити',
      sendSignHintExtension: 'Оберіть монету, введіть адресу та суму, потім підтвердьте переказ у Sui-гаманці.',
      sendSignHintZkLogin: 'Оберіть монету, введіть адресу та суму, потім надішліть через Google zkLogin. Якщо не вийде — увійдіть через Google знову.',
    ...
    mint: {
      ...
      adminCapMissing: 'Задайте VITE_SUI_RWA_ADMIN_CAP_ID (об’єкт RWA AdminCap у вашому гаманці) і переконайтеся, що VITE_SUI_RWA_PACKAGE_ID відповідає rwa_core.',
  ...
  ru: {
    ...
    hero: {
      ...
      sendSignButton: 'Отправить',
      sendSignHintExtension: 'Выберите монету, введите адрес и сумму, затем подтвердите перевод в Sui-кошельке.',
      sendSignHintZkLogin: 'Выберите монету, введите адрес и сумму, затем отправьте через Google zkLogin. Если не получится — войдите через Google снова.',
    ...
    mint: {
      ...
      adminCapMissing: 'Укажите VITE_SUI_RWA_ADMIN_CAP_ID (объект RWA AdminCap в вашем кошельке) и убедитесь, что VITE_SUI_RWA_PACKAGE_ID соответствует rwa_core.',
